...
const COMMANDS = {
  ...
  projects: {
    ...
    execute() {
      return [
        { text: "Nexus Gaming Hub", type: "success" },
        {
          text: "  Full-stack gaming platform with React, Node.js, MySQL.",
          type: "response",
        },
        {
          text: "  Features RBAC dashboards and SQL injection prevention.",
          type: "response",
        },
        { text: "", type: "response" },
        { text: "Conditional GANs for Image Translation", type: "success" },
        {
          text: "  Led 6-member research team. 95% discriminator accuracy.",
          type: "response",
        },
        { text: "", type: "response" },
        { text: "Autonomous Parking Simulation", type: "success" },
        {
          text: "  3D simulation with RL agent using PPO in Unity ML-Agents.",
          type: "response",
        },
      ];
    },
